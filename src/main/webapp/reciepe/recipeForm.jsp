<%@ page contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
  ...
  <head>
    ...
    <!-- Favicon-->
    <script src="/reciepe/reciepeJS/recipeForm.js" defer></script>
            ...
            <form class="row g-3" action="#" method="post" enctype="multipart/form-data">
              ...
              <div class="col-md-6">
                <label for="writer_name" class="form-label">등록자</label> <input type="text" class="form-control"
                  id="writer_name" value="한식매니아" disabled>
              </div>
              <div class="col-md-6">
                <label for="recipe_time" class="form-label">조리시간</label>
                <input type="number" class="form-control" id="recipe_time">
              </div>
              <div class="col-md-4">
              ...
              <div class="col-12 seqContainer" id="recipe_sequence">
